...
const externalToolchains: Readonly<Record<Exclude<Language, "typescript" | "javascript" | "vue">, readonly CommandToolchain[]>> = {
...
export const discoverSemanticToolchains = (
  ...
  const tools = language === "typescript" || language === "javascript" || language === "vue"
